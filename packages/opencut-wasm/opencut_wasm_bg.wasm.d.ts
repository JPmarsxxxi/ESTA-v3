...
export const wasm_bindgen__convert__closures_____invoke__h328812056897e0cd: (a: number, b: number, c: any) => [number, number];
export const wasm_bindgen__convert__closures_____invoke__h4b3060f33e3c4576: (a: number, b: number, c: any, d: any) => void;
export const wasm_bindgen__convert__closures_____invoke__he2009f21b86b77fe: (a: number, b: number, c: any) => void;
