...
const webFiles = ["apps/editor/src/**/*.{ts,tsx}"];
...
export default [
	...
	// ESTA backend: plain Node, run with type stripping.
	...tseslint.configs.recommended.map((config) => ({ ...config, files: ["server/**/*.ts", "scripts/**/*.ts"] })),
	{
